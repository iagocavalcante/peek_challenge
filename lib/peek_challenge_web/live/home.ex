defmodule PeekChallengeWeb.HomeLive do
  use PeekChallengeWeb, :live_view
  ...
  def render(assigns) do
          ...
          <div class="mx-auto max-w-2xl lg:max-w-5xl">
            <div class="max-w-2xl">
              <h1 class="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
                <%= gettext("Software alchemist, co-founder, and maker.") %>
              </h1>
    ...
    <div class="mt-16 sm:mt-20">
      <div class="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8"></div>
    </div>
